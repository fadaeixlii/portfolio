...
export function SiteFooter() {
  ...
  return (
    <footer className="mt-[var(--space-32)] pb-[var(--space-12)]">
      {/* Same 1180px cap as the shell, with the gutter *inside* it. The shell
          caps at 1180 and lets each column add its own px-6, so page content
          lives at 1180-minus-gutter. A footer capped at 1180 with the padding
          outside would hang 24px past the content on both edges. */}
      <div className="mx-auto max-w-[1180px] px-[var(--space-6)]">
        <Hairline className="mb-[var(--space-12)]" />
        <div className="grid gap-[var(--space-8)] md:grid-cols-[1.4fr_1fr_1fr]">
          <p
